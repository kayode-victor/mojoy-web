...
export const createAnOrder = createAsyncThunk(
  ...
  async (orderDetail, thunkAPI) => {
    try {
      console.log("Creating order with data:", orderDetail);
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateCartProduct.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.info("Produuct updated from cart successfully.");
        }
      })
      ...
      .addCase(deleteCartProduct.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.info("Produuct delete from cart successfully.");
        }
      })
      ...
      .addCase(forgetPasswordToken.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.info("Forgot password email sent successful.");
        }
      })
      ...
      .addCase(resetPassword.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.info("Password updated successful.");
        }
      })
